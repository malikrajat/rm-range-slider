...
import { EventEmitter, numberAttribute, Output, Input, ChangeDetectionStrategy, Component } from '@angular/core';
...
class RmRangeSliderComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.2", ngImport: i0, type: RmRangeSliderComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "16.1.0", version: "22.0.2", type: RmRangeSliderComponent, isStandalone: true, selector: "rm-range-slider", inputs: { startValue: ["startValue", "startValue", numberAttribute], endValue: ["endValue", "endValue", numberAttribute], min: ["min", "min", numberAttribute], max: ["max", "max", numberAttribute] }, outputs: { onValueChanged: "onValueChanged" }, ngImport: i0, template: `
    <mat-slider
      [min]="this.min"
      [max]="this.max"
      showTickMarks
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.2", ngImport: i0, type: RmRangeSliderComponent, decorators: [{
            type: Component,
  ...
  `, changeDetection: ChangeDetectionStrategy.Eager, styles: ["mat-slider{width:100%}\n"] }]
